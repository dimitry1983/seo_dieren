...
<div class="flex items-center space-x-2 flex-wrap mb-2">
    <ul class="flex items-center space-x-2 flex-wrap">
        <li><a href="{{route('company.dashboard')}}" class="text-base text-[#f65317]"><strong>Dashboard</strong></a></li>
...
<div class="flex items-center space-x-2 flex-wrap mb-2">
    <ul class="flex items-center space-x-2 flex-wrap">
        <li><a href="{{route('company.dashboard')}}" class="text-base text-[#f65317]">Dashboard</a></li>

        <span class="text-base text-[#FD7CB4]">/</span>

        <li><a href="{{$breadcrumbData['url_one']}}" class="text-base text-[#f65317]"> {!! $breadcrumbData['name_one'] !!}</a></li>
