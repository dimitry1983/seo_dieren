@if (isset($breadcrumbs['total']) && $breadcrumbs['total'] === 1)
    <div class="flex items-center space-x-2 flex-wrap mb-5">
        <span class="text-base text-[#5d4fc4]">{{ devTranslate('breadcrumb.U bevindt zich hier:', 'U bevindt zich hier:') }}</span>
        <ul class="flex items-center space-x-2 flex-wrap">
            <li><a href="/" class="text-base text-[#5d4fc4]">Home</a></li>

            <span class="text-base text-[#5d4fc4]">/</span>
...
@elseif (isset($breadcrumbs['total']) && $breadcrumbs['total'] ?? 0 === 2)
    <div class="flex items-center space-x-2 flex-wrap mb-5">
        ...
        <ul class="flex items-center space-x-2 flex-wrap">
            ...
            <li><a href="{{$breadcrumbData['url_one']}}" class="text-base text-[#5d4fc4]"> {!! $breadcrumbData['name_one'] !!}</a></li>
