<div class="py-4">
    <div class="container px-4 mx-auto flex justify-center items-center">
        ...
        <button id="toggleBtn" class="group peer lg:hidden ml-auto bg-primary text-white peer-open:mt-10 px-2 py-2 ">
            ...
            <span class="top-0 block mt-2 bg-white w-8 h-[2px] transition origin-top-center relative group-open:-rotate-45 group-open:-top-[10px] group-open:border-none"></span>
        </button>
