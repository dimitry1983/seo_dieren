                ...
                <?php for ($i = 0; $i < 6; $i++): ?>
                    <div class="relative border-solid border-[1px] border-[#DBDBDB] rounded-[20px] px-12 py-10 flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-14">
                        <div class="col-span-4 text-center pt-6">
                            <div class="px-10">
                                <img src="./public/img/9a95e270ed8d7624866c68a3d45d16c15b6a4c64.png" class="object-contain aspect-[2.13]" />
                            </div>
                        ...
                        <div class="absolute -top-[16px] left-5 lg:left-10">
                            ...
                            <span class="text-lg text-white absolute left-3 w-full font-semibold text-center z-10 top-6">Top <?= $i+1 ?></span>
