                ...
                <div class="flex items-center order-2 lg:order-1 gap-6 w-full lg:w-fit">
                    ...
                    <div class="ms-auto relative lg:ms-0">
                        <button class="group flex items-center" data-dropdown>
                            <span class="block relative w-[50px] h-[50px] rounded-full overflow-hidden border-2 border-solid border-[#d1d1d1] group-hover:border-primary duration-300 me-3"><img class="abs-cover" src="./public/img/user.jpg" alt=""></span>
                            <span class="text-lg font-medium text-[#271F30]">Jon Doe <i class="fa-regular fa-angle-down text-primary ms-2"></i></span>
                        </button>
                        ...
                        <div class="drop gap-2 border border-solid border-[#D1D1D1] rounded-[8px] px-4 py-3 absolute left-0 top-full translate-y-1 w-full bg-white">
                            <a href="#" class="block duration-300 hover:text-primary">Meni Item</a>
                            <a href="#" class="block duration-300 hover:text-primary">Meni Item</a>
                        </div>
                    </div>
                </div>
