...
use App\Filament\Admin\Resources\SeoVeterinarianResource\Pages\CreateSeoVeterinarian;
use App\Filament\Admin\Resources\SeoVeterinarianResource\Pages\EditSeoVeterinarian;
use App\Filament\Admin\Resources\SeoVeterinarianResource\Pages\ListSeoVeterinarians;
...
class SeoVeterinarianResource extends Resource
{
    protected static ?string $model = SeoVeterinarian::class;
    ...
    {
        return [
            'index' => ListSeoVeterinarians::route('/'),
            'create' => CreateSeoVeterinarian::route('/create'),
            'edit' => EditSeoVeterinarian::route('/{record}/edit'),
        ];
    }
}
